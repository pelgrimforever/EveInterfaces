/*
 * eView_shipfitorderselected.java
 *
...
/**
 * View class View_shipfitorderselected
 * 
 * Attributes: fields
 * Attributes: Database independent SQL-construction strings
 * Conversion methods for java.sql.ResultSet ==> View_shipfitorderselected Entity
 * 
...
public class eView_shipfitorderselected implements eveDatabaseproperties, EntityView {
    ...
    /**
     * 
     * @return view name for View_shipfitorderselected
     */
    public String getTable() { return table; }

    /**
     * 
     * @return View_shipfitorderselected class name
     */
    public String getClassName() { return this.getClass().getName(); };
	  
    /** 
     * Constructor
     * Creates an empty View_shipfitorderselected entity
     */
    public eView_shipfitorderselected() {
    }

    /**
     * @return is View_shipfitorderselected Empty ?
     */
