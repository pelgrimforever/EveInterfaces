 ...
 */
public interface IOrder_hist extends LogicEntity {

	public IOrder_histPK getPrimaryKey();
    ...
    public static final int SIZE_VOLUME_TOTAL = 10;
    public static final int SIZE_VOLUME_REMAIN = 10;
    ...
    public static final byte[] fieldtypes = { Datatypes.type_long, Datatypes.type_boolean, Datatypes.type_long, Datatypes.type_long, Datatypes.type_int, Datatypes.type_int, Datatypes.type_String, Datatypes.type_int, Datatypes.type_double, Datatypes.type_int, Datatypes.type_long, Datatypes.type_boolean, Datatypes.type_Timestamp, Datatypes.type_int };

    public static final String[] evetypePKfields = { "evetype.id" };
    public static final String[] evetypeFKfields = { "order_hist.evetype" };
    public static final String[] systemPKfields = { "system.id" };
    public static final String[] systemFKfields = { "order_hist.system" };
