...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Systemtrade_ordersearch systemtrade_ordersearch) {
        ...
        if(systemtrade_ordersearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = systemtrade_ordersearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = systemtrade_ordersearch.getFieldsearchers().iterator();
