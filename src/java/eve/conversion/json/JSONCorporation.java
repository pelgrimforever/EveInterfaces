...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Corporationsearch corporationsearch) {
        ...
        if(corporationsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = corporationsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = corporationsearch.getFieldsearchers().iterator();
