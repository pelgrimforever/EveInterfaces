...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Region_neighboursearch region_neighboursearch) {
        ...
        if(region_neighboursearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = region_neighboursearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = region_neighboursearch.getFieldsearchers().iterator();
