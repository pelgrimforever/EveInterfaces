...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Security_islandsearch security_islandsearch) {
        ...
        if(security_islandsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = security_islandsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = security_islandsearch.getFieldsearchers().iterator();
