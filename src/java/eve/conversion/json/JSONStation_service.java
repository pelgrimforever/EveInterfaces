...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Station_servicesearch station_servicesearch) {
        ...
        if(station_servicesearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = station_servicesearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = station_servicesearch.getFieldsearchers().iterator();
