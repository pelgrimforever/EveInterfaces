...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Factionsearch factionsearch) {
        ...
        if(factionsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = factionsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = factionsearch.getFieldsearchers().iterator();
