...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Systemtradesearch systemtradesearch) {
        ...
        if(systemtradesearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = systemtradesearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = systemtradesearch.getFieldsearchers().iterator();
