...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Alliancesearch alliancesearch) {
        ...
        if(alliancesearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = alliancesearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = alliancesearch.getFieldsearchers().iterator();
