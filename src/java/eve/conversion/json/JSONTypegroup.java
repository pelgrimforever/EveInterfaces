...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Typegroupsearch typegroupsearch) {
        ...
        if(typegroupsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = typegroupsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = typegroupsearch.getFieldsearchers().iterator();
