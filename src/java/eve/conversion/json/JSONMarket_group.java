...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Market_groupsearch market_groupsearch) {
        ...
        if(market_groupsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = market_groupsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = market_groupsearch.getFieldsearchers().iterator();
