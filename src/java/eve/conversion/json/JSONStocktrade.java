...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Stocktradesearch stocktradesearch) {
        ...
        if(stocktradesearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = stocktradesearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = stocktradesearch.getFieldsearchers().iterator();
