...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Order_histsearch order_histsearch) {
        ...
        if(order_histsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = order_histsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = order_histsearch.getFieldsearchers().iterator();
