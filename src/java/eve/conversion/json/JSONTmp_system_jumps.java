...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Tmp_system_jumpssearch tmp_system_jumpssearch) {
        ...
        if(tmp_system_jumpssearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = tmp_system_jumpssearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = tmp_system_jumpssearch.getFieldsearchers().iterator();
