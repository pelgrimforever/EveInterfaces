...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Tradesearch tradesearch) {
        ...
        if(tradesearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = tradesearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = tradesearch.getFieldsearchers().iterator();
