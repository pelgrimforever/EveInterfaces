...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Systemjumpssearch systemjumpssearch) {
        ...
        if(systemjumpssearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = systemjumpssearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = systemjumpssearch.getFieldsearchers().iterator();
