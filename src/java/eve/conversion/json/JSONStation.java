...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Stationsearch stationsearch) {
        ...
        if(stationsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = stationsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = stationsearch.getFieldsearchers().iterator();
