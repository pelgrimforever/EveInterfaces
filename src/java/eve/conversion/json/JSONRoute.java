...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Routesearch routesearch) {
        ...
        if(routesearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = routesearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = routesearch.getFieldsearchers().iterator();
