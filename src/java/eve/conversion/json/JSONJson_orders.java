...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Json_orderssearch json_orderssearch) {
        ...
        if(json_orderssearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = json_orderssearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = json_orderssearch.getFieldsearchers().iterator();
