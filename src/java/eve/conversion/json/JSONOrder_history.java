...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Order_historysearch order_historysearch) {
        ...
        if(order_historysearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = order_historysearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = order_historysearch.getFieldsearchers().iterator();
