...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Constellation_neighboursearch constellation_neighboursearch) {
        ...
        if(constellation_neighboursearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = constellation_neighboursearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = constellation_neighboursearch.getFieldsearchers().iterator();
