...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Locationsearch locationsearch) {
        ...
        if(locationsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = locationsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = locationsearch.getFieldsearchers().iterator();
