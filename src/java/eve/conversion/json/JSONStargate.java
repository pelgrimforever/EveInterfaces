...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Stargatesearch stargatesearch) {
        ...
        if(stargatesearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = stargatesearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = stargatesearch.getFieldsearchers().iterator();
