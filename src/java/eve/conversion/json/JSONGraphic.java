...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Graphicsearch graphicsearch) {
        ...
        if(graphicsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = graphicsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = graphicsearch.getFieldsearchers().iterator();
