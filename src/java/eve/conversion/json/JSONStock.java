...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Stocksearch stocksearch) {
        ...
        if(stocksearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = stocksearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = stocksearch.getFieldsearchers().iterator();
