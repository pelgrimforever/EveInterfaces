...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Routetypesearch routetypesearch) {
        ...
        if(routetypesearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = routetypesearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = routetypesearch.getFieldsearchers().iterator();
